...
define('COMPANY_LOGO_IMG', 'company_logo/');
define('USER_PROFILE_IMG', 'user_profile/');

define('FRONT_ASSETS',PUBLIC_FILE.'front/assets/');
define('FRONT_IMG',PUBLIC_FILE.'front/images/');

define('FRONTEND','frontend/');
define('BACKEND',PUBLIC_FILE.'backend/');
define('PLUGINS',PUBLIC_FILE.'plugins/');
define('COMMON',PUBLIC_FILE.'common/');

define('CURR_SYMBOL','$');
define('FROM_EMAIL','info@solesolutions.com');
define('SITE_NAME','Sole Solutions');
define('COPY_RIGHT_YEAR','2021');

define('PRODUCT_RECORD_CSV','product_record_csv/');


define('CONTACT_INQ_TO_EMAIL', 'david@tongsamllc.com');
...
define('EMAIL_FROM', 'info@solesolutions.com');// e.g. email@example.com
define('EMAIL_BCC',  'Your bcc email');		// e.g. email@example.com
define('FROM_NAME',  '');	// Your system name
