...
class Ajax_pagination{
    ...
    var $first_link      = '<i class="fa fa-angle-double-left"></i>';//Changed From First To This
    var $next_link       = '<i class="fa fa-angle-right"></i>';
    var $prev_link       = '<i class="fa fa-angle-left"></i>';
    var $last_link       = '<i class="fa fa-angle-double-right"></i>';//Changed From Last To This
    var $uri_segment     = 3;
    ...
    var $cur_tag_open    = '<li><a class="current-page">';
    ...
    function create_links(){
        ...
        if ($this->show_count){
            ...
            $info = '<li>Showing ' . ( $curr_offset + 1 ) . ' to ' ;
