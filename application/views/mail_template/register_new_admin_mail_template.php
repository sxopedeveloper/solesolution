                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                valign="top">
                                <h2 style="font-size: 30px;line-height: 36px;color: #116bf8;">Registered new user</h2>
                            </td>
                        </tr>
                        <!-- <tr>
                            <td style="text-align: center">
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                valign="top">
                                New user registerd to the <?=isset($site_name) ? ucwords($site_name) : SITE_NAME;?> Team.
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                valign="top">
                                Registered user email address is <span style="font-weight: bold;"><?=isset($email) ? $email : '';?></span>. Please assign role to click below button.
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block" itemprop="handler" itemscope
                                ...
                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                valign="top">
                                <a href="<?=isset($role_url) ? $role_url : '';?>" class="btn-primary" itemprop="url"
                                   style="    background: linear-gradient(to right, #116bf8 0%, #00d5a0 100%);
    background: -webkit-linear-gradient(to right, #116bf8 0%, #00d5a0 100%);
    background: -moz-linear-gradient(to right, #116bf8 0%, #00d5a0 100%);
    background: -o-linear-gradient(to right, #116bf8 0%, #00d5a0 100%);color: #fff;text-decoration: none;padding: 10px 50px;text-align: center;border-radius: 5px;-webkit-border-radius: 5px;-moz-border-radius: 5px;-ms-border-radius: 5px;margin: 0 auto;display: table;">Assign Role</a>
                            </td>
                        </tr>
                        <!-- <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
