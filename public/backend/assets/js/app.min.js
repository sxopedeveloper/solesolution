...
$(".desktop-toggle a").click(function (e)
{
	$(".side-nav-mainbox").toggleClass('open');
	$(".main-content").toggleClass('pl-right');
	$(this).toggleClass('active');
});


$(".header .nav-item.dropdown,.header .dropdown-menu").click(function(e){
    e.stopPropagation();
});

$("body").click(function (e)
{
	$(".header .nav-item.dropdown").removeClass('open');
	$(".header ul.dropdown-menu").css('display', 'none');
});